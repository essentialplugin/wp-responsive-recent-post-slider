		...
		<div class="wppsac-sf-welcome-wrap wppsac-sf-center">
			<div class="wppsac-features-box-wrap">
				<ul class="wppsac-features-box-grid">
					<li>
					<div class="wppsac-popup-icon"><img src="<?php echo esc_url(WPRPS_URL); ?>/assets/images/popup-icon/slider.png" /></div>
					Recent Post Slider View</li>
					<li>
					<div class="wppsac-popup-icon"><img src="<?php echo esc_url(WPRPS_URL); ?>/assets/images/popup-icon/slider-carousel.png" /></div>
					Recent Post Carousel View</li>
					<li>
					<div class="wppsac-popup-icon"><img src="<?php echo esc_url(WPRPS_URL); ?>/assets/images/popup-icon/grid-box.png" /></div>
